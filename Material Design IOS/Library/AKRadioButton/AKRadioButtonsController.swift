...
class AKRadioButtonsController: NSObject {
    ...
    var startGradColorForSelected : UIColor = UIColor(red: 254/255, green: 163/255, blue: 23/255, alpha: 1.0) {
    didSet {
    self.redrawButtons()
    }
    }
    var endGradColorForSelected : UIColor = UIColor(red: 254/255, green: 163/255, blue: 23/255, alpha: 1.0) {
        didSet {
            self.redrawButtons()
        }
    }
