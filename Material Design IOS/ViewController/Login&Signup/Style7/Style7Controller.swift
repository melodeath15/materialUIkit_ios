...
class Style7Controller: UIViewController, UITableViewDelegate, UITableViewDataSource, HeaderStyle1Delegate, FieldStyle7Delegate, TapSwepStyle4Delegate, FieldStyle17Delegate {
    ...
    func signInFB() { // function sign facebook
