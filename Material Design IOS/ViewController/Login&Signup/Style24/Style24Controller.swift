...
class Style24Controller: UIViewController, HeaderStyle1Delegate, ViewStyle23Delegate {
    ...
    func createView() {
        ...
        Nav.titleHeader.text = "Verify your Account"
        ...
        ViewMenu.title.text = "Please enter your phone number"
        ViewMenu.btnReset.setTitle("Verify Phone Number", for: .normal)
        ViewMenu.email.keyboardType = .phonePad
        ViewMenu.email.placeholder = "Phone Number"
    ...
    func resetPassword() { // function reset password
        FunctionDefault.AlertMessage(title: "Verify Phone Number", message: "", targetVC: self)
    }
    // end
