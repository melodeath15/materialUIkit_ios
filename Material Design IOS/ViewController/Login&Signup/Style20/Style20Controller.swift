...
class Style20Controller: UIViewController, HeaderStyle1Delegate, ViewStyle20Delegate, FieldStyle10Delegate {
    ...
    override func viewDidLoad() {
        ...
        createView() // call function for create background, create nav, create viewbg, create viewsignup, create viewsignin,
    }
    
    func createView() {
        // Create Background
        let imageView = UIImageView(image: UIImage(named: "bg3a"))
    ...
    func textChange(text: String, tag: NSInteger) { // function for get textfield
        if show == true{
            ...
            print("Textfield Result SignIn = \(text)") // show all FieldStyle10Delegate
        }else if show == false{
            print("Sign Up")
            switch tag {
            case 0:
