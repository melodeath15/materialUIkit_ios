...
class Style8Controller: UIViewController, UITableViewDelegate, UITableViewDataSource, HeaderStyle1Delegate, FieldStyle8Delegate {
    ...
    override func viewDidLoad() {
        ...
        createView() // call function create view for, create header, table and regis xib/UINib
    ...
    func createView() {
        ...
        tableStyle.register(UINib(nibName: "FieldStyle8", bundle: nil), forCellReuseIdentifier: "FieldStyle8")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            return cell
        case 1:
            let cell = tableView.dequeueReusableCell(withIdentifier: "FieldStyle8", for: indexPath) as! FieldStyle8
