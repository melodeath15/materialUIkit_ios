...
class Style6Controller: UIViewController, UITableViewDelegate, UITableViewDataSource, HeaderStyle1Delegate, ButtonSyle6Delegate, FieldStyle6Delegate, FieldStyle11Delegate{

    private var tableSignUp: UITableView = UITableView()
    private var tableSignIn: UITableView = UITableView()
    ...
    func createView() {
        ...
        headerImg.btnSignIn.setTitleColor(UIColor.lightGray, for: .normal)
        headerImg.btnSignUp.setTitleColor(UIColor.white, for: .normal)
    ...
    func CreateAccount() { // function create accout
