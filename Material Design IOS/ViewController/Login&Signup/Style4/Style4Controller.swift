...
class Style4Controller: UIViewController, UITableViewDelegate, UITableViewDataSource, HeaderStyle1Delegate, FieldTyle4Delegate, TapSwepStyle4Delegate, FieldStyle11Delegate {
    ...
    func createView() {
        ...
        headerMenu.btnSignUp.setTitleColor(UIColor.white, for: .normal)
        headerMenu.btnSIgnIn.setTitleColor(UIColor.lightText, for: .normal)
        headerMenu.viewButton.isHidden = false
        headerMenu.viewButton2.isHidden = true
    ...
    // Delegate FieldStyle4Delegate and FieldStyle11Delegate
    ...
    func Term() { // function button term of service
    ...
    func cekBoxStatus(status: M13Checkbox) { // function  cekbox
