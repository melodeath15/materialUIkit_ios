//
//  GalleryControllerStyle7View.swift
//  Material Design IOS
//
...
class GalleryControllerStyle7View: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = GalleryControllerStyle7Tap1(itemInfo: "PHOTO")
        let child_2 = GalleryControllerStyle7Tap1(itemInfo: "VIDEO")
        let child_3 = GalleryControllerStyle7Tap1(itemInfo: "DOCUMENT")
