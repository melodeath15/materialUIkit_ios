//
//  GalleryControllerStyle7Tap1.swift
//  Material Design IOS
//
...
class GalleryControllerStyle7Tap1: UIViewController, IndicatorInfoProvider, UITableViewDelegate, UITableViewDataSource, GalleryStyle7CollectionDelegate {
    ...
    override func viewDidLoad() {
        ...
        listName = ["RECENT PHOTOS", "LAST WEEK"]
        list1 = [
    ...
    func pushCellSelect(tag: Int, count: Int, data: NSArray) {
        selected += count
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "selected"), object: selected)
    }
