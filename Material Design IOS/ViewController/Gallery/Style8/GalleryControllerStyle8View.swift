//
//  GalleryControllerStyle8View.swift
//  Material Design IOS
//
...
class GalleryControllerStyle8View: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = GalleryControllerStyle8Tap1(itemInfo: "PHOTO")
        let child_2 = GalleryControllerStyle8Tap1(itemInfo: "VIDEO")
        let child_3 = GalleryControllerStyle8Tap1(itemInfo: "DOCUMENT")
