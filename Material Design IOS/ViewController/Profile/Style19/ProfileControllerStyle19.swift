//
//  ProfileControllerStyle19.swift
//  Material Design IOS
//
...
class ProfileControllerStyle19: UIViewController, UITableViewDelegate, UITableViewDataSource, ProfileHeaderDelegate, ProfileCollectionMenuStyle19Delegate, GalleryStyle1CollectionDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        default:
            ...
            cell.title.text = listName[indexPath.row-2] as? String
            ...
            cell.collectionImg.tag = indexPath.row-2
