//
//  ProfileControllerStyle30.swift
//  Material Design IOS
//
...
class ProfileControllerStyle30: UIViewController, UITableViewDelegate, UITableViewDataSource, ProfileHeaderDelegate, ProfileHeaderStyle30Delegate, GalleryStyle1CollectionDelegate {
    ...
    func createView(){
        ...
        table.register(UINib(nibName: "ProfileHeaderStyle30", bundle: nil), forCellReuseIdentifier: "ProfileHeaderStyle30")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0{
            let cell = tableView.dequeueReusableCell(withIdentifier: "ProfileHeaderStyle30", for: indexPath)as! ProfileHeaderStyle30
            
            cell.active = status
            cell.counter = ["359", "10.289", "4317"]
            cell.title = ["Photos", "Videos", "Friends"]
            cell.img = ["photo", "photo", "photo"]
