//
//  EcommerceControllerStyle5View.swift
//  Material Design IOS
//
...
class EcommerceControllerStyle5View: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = EcommerceControllerStyle5Tap1(itemInfo: "PROMO")
        let child_2 = EcommerceControllerStyle5Tap1(itemInfo: "WOMEN")
        let child_3 = EcommerceControllerStyle5Tap1(itemInfo: "MEN")
        let child_4 = EcommerceControllerStyle5Tap1(itemInfo: "KIDS")
