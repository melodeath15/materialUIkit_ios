//
//  EcommerceControllerStyle9View.swift
//  Material Design IOS
//
...
class EcommerceControllerStyle9View: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = EcommerceControllerStyle9Tap1(itemInfo: "ALL")
        let child_2 = EcommerceControllerStyle9Tap1(itemInfo: "POPULAR")
        let child_3 = EcommerceControllerStyle9Tap1(itemInfo: "NEW")
