//
//  EcommerceControllerStyle7View.swift
//  Material Design IOS
//
...
class EcommerceControllerStyle7View: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = EcommerceControllerStyle7Tap1(itemInfo: "PROMO")
        let child_2 = EcommerceControllerStyle7Tap1(itemInfo: "WOMEN")
        let child_3 = EcommerceControllerStyle7Tap1(itemInfo: "MEN")
        let child_4 = EcommerceControllerStyle7Tap1(itemInfo: "KIDS")
