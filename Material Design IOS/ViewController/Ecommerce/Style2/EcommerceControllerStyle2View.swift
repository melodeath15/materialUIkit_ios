//
//  EcommerceControllerStyle2View.swift
//  Material Design IOS
//
...
class EcommerceControllerStyle2View: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = EcommerceControllerStyle2Tap1(itemInfo: "PROMO")
        let child_2 = EcommerceControllerStyle2Tap1(itemInfo: "WOMEN")
        let child_3 = EcommerceControllerStyle2Tap1(itemInfo: "MEN")
        let child_4 = EcommerceControllerStyle2Tap1(itemInfo: "KIDS")
