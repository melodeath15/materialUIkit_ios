//
//  MenuLeftControllerStyle15.swift
//  Material Design IOS
//
...
class MenuLeftControllerStyle15: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, MenuStyle3FooterDelegate, MenuStyle15FooterDelegate {
    ...
    override func viewDidLoad() {
        ...
        createView() // creater footer, create table and regis UINib
    }
    ...
    func createView(){
        ...
        // Create Table
        let newView = UIView()
        newView.frame = CGRect(x: 0, y: -20, width: self.view.frame.size.width, height: self.view.frame.size.height-80-50)
        ...
        footer.frame = CGRect(x: 0, y: self.view.frame.size.height-70-80, width: self.view.frame.size.width, height: 50)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.iconNext.textColor = UIColor.white
