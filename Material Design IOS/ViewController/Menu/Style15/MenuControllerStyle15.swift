...
class MenuControllerStyle15: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, MenuStyle11HeaderDelegate {
    ...
    func createView(){
        ...
        // Create MenuShow
        menuShow = (storyboard?.instantiateViewController(withIdentifier: "MenuLeftControllerStyle15"))!
        addChildViewController(menuShow)
        menuShow.view.frame = CGRect(x: -self.view.frame.size.width, y: 80, width: self.view.frame.size.width, height: self.view.frame.size.height-80)
        ...
        header.backgroundColor = UIColor.init(red: 44/255.0, green: 57/255.0, blue: 64/255.0, alpha: 1)
        header.searchBarCustom.tintColor = UIColor.init(red: 44/255.0, green: 57/255.0, blue: 64/255.0, alpha: 1)
        header.searchBarCustom.barTintColor = UIColor.init(red: 44/255.0, green: 57/255.0, blue: 64/255.0, alpha: 1)
        
        header.searchBarCustom.layer.borderColor = UIColor.init(red: 44/255.0, green: 57/255.0, blue: 64/255.0, alpha: 1).cgColor
        header.searchBarCustom.layer.borderWidth = 0.5
        header.searchBarCustom.clipsToBounds = true
    ...
    func menu() { // function for menu
        if show {
            ...
            UIView.animate(withDuration: 0.5, animations: {
                self.menuShow.view.frame.origin.x = -self.view.frame.size.width
