...
class MenuControllerStyle9: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, MenuStyle1HeaderDelegate {
    ...
    func createView(){
        ...
        revealViewController().rearViewRevealWidth = self.view.frame.size.width/3.5
