...
class MenuControllerStyle7: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, MenuStyle1HeaderDelegate {
    ...
    func createView(){
        ...
        // Create MenuShow
        menuShow = (storyboard?.instantiateViewController(withIdentifier: "MenuLeftControllerStyle7"))!
