...
class MenuControllerStyle8: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, MenuStyle1HeaderDelegate {
    ...
    func createView(){
        ...
        // Create MenuShow
        menuShow = (storyboard?.instantiateViewController(withIdentifier: "MenuLeftControllerStyle8"))!
