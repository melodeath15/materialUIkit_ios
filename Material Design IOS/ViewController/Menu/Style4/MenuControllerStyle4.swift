...
class MenuControllerStyle4: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, MenuStyle1HeaderDelegate {
    ...
    func createView(){
        ...
        // Create MenuShow
        menuShow = (storyboard?.instantiateViewController(withIdentifier: "MenuLeftControllerStyle4"))!
    ...
    func search() { // function for menu option
        // not use because hidden button
    }
    
    func optional() { // function for search
