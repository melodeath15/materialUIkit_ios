//
//  ActivityStyle25Controller.swift
//  Material Design IOS
//
...
class ActivityStyle25Controller: UIViewController, UITableViewDataSource, UITableViewDelegate, ViewActivityStyle1HeaderDelegate {
    ...
    func createView(){
        ...
        tableStyle.register(UINib(nibName: "ViewActivitySytle25", bundle: nil), forCellReuseIdentifier: "ViewActivitySytle25")
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        if section == 0 {
            ...
            headercell.title.textAlignment = NSTextAlignment.center
            headercell.title.text = "Today, 24 June 2016"
        }else{
            headercell.title.textAlignment = NSTextAlignment.center
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0{
            let cell = tableView.dequeueReusableCell(withIdentifier: "ViewActivitySytle25", for: indexPath) as! ViewActivitySytle25
            ...
            cell.cellBluer.backgroundColor = UIColor.init(red: 255/255.0, green: 255/255.0, blue: 255/255.0, alpha: 0)
            return cell
            ...
            cell.cellBluer.backgroundColor = UIColor.init(red: 255/255.0, green: 255/255.0, blue: 255/255.0, alpha: 0.8)
            return cell
