//
//  ActivityStyle1Controller.swift
//  Material Design IOS
//
...
class ActivityStyle1Controller: UIViewController, UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, ViewActivityStyle1HeaderDelegate {
