...
class YoutubeTap: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = YoutubeController(itemInfo: "HOME")
        let child_2 = YoutubeController(itemInfo: "TRENDING")
        let child_3 = YoutubeController(itemInfo: "SUBSCRIPTION")
