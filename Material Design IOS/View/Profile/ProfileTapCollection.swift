//
//  ProfileTapCollection.swift
//  Material Design IOS
//
//  Created by Denis Tirta Prada on 11/1/17.
//  Copyright © 2017 Mediatechindo. All rights reserved.
//

import UIKit

protocol ProfileTapCollectionDelegate {
    func activeMenu(index: IndexPath)
}

class ProfileTapCollection: UIView, UICollectionViewDelegate, UICollectionViewDataSource {
    
    var delegate: ProfileTapCollectionDelegate?
